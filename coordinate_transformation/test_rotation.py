...
class TestRotation(unittest.TestCase):
    ...
    def test_rotation_1(self):
        ...
        self.assertTrue(np.allclose(point_after, rotate_2D(point_before, rotation_degree)))
    ...
    def test_rotation_5(self):
        ...
        points_rotated = np.array([rotate_2D(point, rotation_angle) for point in points])
